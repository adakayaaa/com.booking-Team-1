...
public class HotelsBookingPageStepDefs extends BaseStep {

	Logger logger = LogManager.getLogger(HotelsBookingPageStepDefs.class);
	...
	public void theUserShouldSeeThatErrorMessageAs(String errorMessage) {
		...
		BrowserUtils.wait(2);
		then(PAGES.getHotelsBookingPage().getErrorMessage()).withFailMessage("Error message does not show up")
