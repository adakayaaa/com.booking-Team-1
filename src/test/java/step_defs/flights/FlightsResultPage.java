...
public class FlightsResultPage extends BaseStep {
    ...
    public void theUserShouldSeeThatAdultNumberAsAndChildrenNumberAsOnTheResultPage(String countOfAdult, String countOfChildren) {
        then(PAGES.getFlightsResultPage().getCountOfAdult()).isEqualTo(Integer.parseInt(countOfAdult)).withFailMessage("The count of adult is wrong!");
        then(PAGES.getFlightsResultPage().getCountOfChildren()).isEqualTo(Integer.parseInt(countOfChildren)).withFailMessage("The count of children is wrong!");
    }
