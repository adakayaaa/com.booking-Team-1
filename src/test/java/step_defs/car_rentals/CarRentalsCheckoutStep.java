...
public class CarRentalsCheckoutStep extends BaseStep {
    ...
    (String pick_up_location, String transmission, String car_category) {
            then(PAGES.getCarRentalsCheckoutPage().getPickedUpLocationOfSelectedCarInCheckoutPage()).isEqualTo(pick_up_location);
    ...
    (String firstName,
     ...
     String cvv) {
        PAGES.getCarRentalsCheckoutPage().enterCheckoutProcessInformation(firstName,lastName,phoneNumber,country,
                address,city,postalCode,cardholderName,cardNumber,expirationDate,cvv);
    }
